    ...
    <div className="pt-20 md:pt-16">
      ...
      >
        ...
        <div className="relative container mx-auto px-4 text-center">
            ...
            Contact Us for your Best Nepali Coffee Experience
            </h1>
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto">
            We'd love to hear from you. Reach out with questions about our best Nepali coffee, wholesale inquiries, coffee export services, or feedback about your coffee experience.
          </p>
        </div>
      </div>
