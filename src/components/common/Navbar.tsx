      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        > 
          ...
          <span className={scrolled || !isHomePage ? 'text-navy-900' : 'text-white'}>
           ...
           {scrolled || !isHomePage?(
            <img src="public/images/Coffee_logo.png" alt="Alpico coffee logo" className='flex items-center gap-2 w-30 h-20' />)
            :(
            <img src="public/images/Coffee_logo_white.svg" alt="Alpico coffee logo" className='flex items-center gap-2 w-30 h-20' />
            )
          }
        </Link>
